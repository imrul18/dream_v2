...
const Release = ({ currentStep, setCurrentStep }) => {
  ...
  const clickNext = async () => {
    ...
    if (updateData?.original_release_date) {
    ...
    if (updateData?.primary_artist?.length) {
        ...
        <div className="row release-row">
          ...
          <div className="col-xl-3 col-lg-6 mt-4">
            <form className="r_input_group">
              ...
              <MultiSelect
                data={updateData?.primary_artist}
                ...
                <div className="checkbox_item">
                  <div className="item">
                    <input
                      type="checkbox"
                      checked={
                        updateData?.various_art_compilation ? true : false
                      }
                      onChange={(e) =>
                        setData({
          ...
          <div className="col-xl-3 col-lg-6 mt-4">
            <form className="r_input_group">
              <div className="mt-3">
                ...
                <Select
                  ...
                  value={genreOption?.find(
                    (itm) => itm?.value === updateData?.genre
                  )}
              ...
              <div className="mt-3">
                ...
                <Select
                  ...
                  value={labelOption?.find(
                    (itm) => itm?.value === updateData?.label
                  )}
              ...
              <div className="mt-3">
                ...
                <Select
                  ...
                  value={formatOption?.find(
                    (itm) => itm?.value === updateData?.format
                  )}
              ...
              <div className="input_f mt-3">
                ...
                <div>
                  <DatePicker
                    selected={new Date(updateData?.original_release_date ?? null)}
                    onChange={(date) =>
          ...
          <div className="col-xl-3 col-lg-6 mt-4">
            <form className="r_input_group">
              ...
              <div className="mt-3">
                ...
                <Select
                  ...
                  value={productionYearOption?.find(
                    (itm) => itm?.value == updateData?.production_year
                  )}
              ...
              <div className="input_f mt-3">
                ...
                <input
                  type="text"
                  value={updateData?.producer_catalogue_number}
                  onChange={(e) =>
